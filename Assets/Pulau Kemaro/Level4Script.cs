...
public class Level4Script : MonoBehaviour {
	...
	public InputField Level4Box;
	public Button CheckLevel4;
	public Text AnswerPulauKemaro;
	...
	void Start () {
		...
		Level4Box = Level4Box.GetComponent<InputField> ();
		CheckLevel4 = CheckLevel4.GetComponent<Button> ();
		AnswerPulauKemaro = AnswerPulauKemaro.GetComponent<Text> ();
		AnswerPulauKemaro.enabled = false;
		...
		if (selesai == 1) {
			...
			Destroy (GameObject.Find ("no 8"));
			Destroy (GameObject.Find ("no 9"));
			Destroy (GameObject.Find ("InputFieldLevel4"));
			Destroy (GameObject.Find ("CheckLevel4"));
			AnswerPulauKemaro.enabled = true;
			SetScore ();
		}
	}
	...
	public void Checkno1Pressed(){
		if (no1box.text == "Kalimantan Utara") {
			Destroy (GameObject.Find ("no 1"));
			score = score - 10;
			buka1 = 1;
			PlaySFX(1);
	...
	public void Checkno2Pressed(){
		if (no2box.text == "Negara Kepulauan") {
			Destroy(GameObject.Find ("no 2"));
			score = score - 10;
			buka2 = 1;
			PlaySFX(1);
	...
	public void Checkno7Pressed(){
		if (no7box.text == "Megawati Soekarno Putri") {
			Destroy(GameObject.Find ("no 7"));
			score = score - 10;
			buka7 = 1;
			PlaySFX(1);
	...
	public void Checkno9Pressed(){
		if (no9box.text == "Sumatera Selatan") {
			Destroy (GameObject.Find ("no 9"));
			score = score - 10;
			buka9 = 1;
			PlaySFX(1);
	...
	public void CheckLevel4Pressed(){
		if (Level4Box.text == "Pulau Kemarau") {
			Destroy (GameObject.Find ("no 1"));
			Destroy (GameObject.Find ("no 2"));
			Destroy (GameObject.Find ("no 3"));
			Destroy (GameObject.Find ("no 4"));
	...
	/*void StoreAllInformation(){
		GameInformation.Score = Level4Script.score;
		GameInformation.Level = Level4Script.level;
	}*/
}
