...
public class Level3Script : MonoBehaviour {
	...
	public InputField Level3Box;
	public Button CheckLevel3;
	public Text AnswerGeloraSriwijaya;
	...
	void Start () {
		...
		Level3Box = Level3Box.GetComponent<InputField> ();
		CheckLevel3 = CheckLevel3.GetComponent<Button> ();
		AnswerGeloraSriwijaya = AnswerGeloraSriwijaya.GetComponent<Text> ();
		AnswerGeloraSriwijaya.enabled = false;
		
		ScoreDisplay = ScoreDisplay.GetComponent<Text> ();
		score = 100;

		if (buka1 == 1) {
			Destroy (GameObject.Find ("nomor1"));
		}
		if (buka2 == 1) {
			Destroy (GameObject.Find ("nomor2"));
		}
		if (buka3 == 1) {
			Destroy (GameObject.Find ("nomor3"));
		}
		if (buka4 == 1) {
			Destroy (GameObject.Find ("nomor4"));
		}
		if (buka5 == 1) {
			Destroy (GameObject.Find ("nomor5"));
		}
		if (buka6 == 1) {
			Destroy (GameObject.Find ("nomor6"));
		}
		if (buka7 == 1) {
			Destroy (GameObject.Find ("nomor7"));
		}
		if (buka8 == 1) {
			Destroy (GameObject.Find ("nomor8"));
		}
		if (buka9 == 1) {
			Destroy (GameObject.Find ("nomor9"));
		}
		if (selesai == 1) {
			Destroy (GameObject.Find ("nomor1"));
			Destroy (GameObject.Find ("nomor2"));
			...
			Destroy (GameObject.Find ("nomor8"));
			Destroy (GameObject.Find ("nomor9"));
			Destroy (GameObject.Find ("InputFieldLevel3"));
			Destroy (GameObject.Find ("CheckButtonLevel3"));
			AnswerGeloraSriwijaya.enabled = true;
			SetScore();
		}
	}
	...
	public void Checkno4Pressed(){
		if (no4box.text == "Institut Teknologi Bandung") {
			Destroy(GameObject.Find("nomor4"));
			score = score - 10;
			buka4 = 1;
			PlaySFX(1);
	...
	public void CheckLevel3Pressed(){
		if (Level3Box.text == "Gelora Sriwijaya") {
			Destroy (GameObject.Find ("nomor1"));
			Destroy (GameObject.Find ("nomor2"));
			Destroy (GameObject.Find ("nomor3"));
			Destroy (GameObject.Find ("nomor4"));
	...
	/*void StoreAllInformation(){
		GameInformation.Score = Level3Script.score;
		GameInformation.Level = Level3Script.level;
	}*/
}
